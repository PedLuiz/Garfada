    ...
    <section className="mx-auto w-full max-w-6xl overflow-hidden rounded-[2rem] border border-[#efc9a9] bg-white shadow-[0_24px_64px_rgba(176,94,35,0.14)]">
      <div className="grid lg:grid-cols-[1.06fr_0.94fr]">
        ...
        <aside className="relative hidden min-h-full lg:block">
          ...
          <div className="absolute inset-x-7 bottom-7 rounded-3xl border border-white/25 bg-white/10 p-5 text-white backdrop-blur-sm">
            {panelBadge && (
            ...
            <h2 className={`${panelBadge ? 'mt-3' : ''} font-display text-3xl leading-tight text-white`}>{imageTitle}</h2>
